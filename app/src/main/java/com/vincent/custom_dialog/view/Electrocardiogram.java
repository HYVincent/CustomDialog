...
//        setData();							// 设置数据
        setElectrocardiogramData(datas);
    }
...
//                generateElectrocar();
    ...
    public void startDraw(){
        runnable = new Runnable() {
            ...
            public void run() {
                addData();
                mHandler.postDelayed(runnable,125/1000);		// 100 ms 增加一个数据
            }
        };
    ...
    public void setElectrocardiogramData(List<Float> data){
        this.datas = data;
    }
    ...
    private void drawGird(Canvas canvas) {
        paint.setColor(Color.parseColor("#53bfed"));                   // 网格浅蓝色
        // 横向的网格
